...
class ServiceDiscovery():
    def __init__(self):
        ...
        try:
            ...
            self.system_bus.add_signal_receiver(self.avahi_dbus_connect_cb, "NameOwnerChanged", "org.freedesktop.DBus",
    ...
    def new_service(self, interface, protocol, name, type, domain, flags):
        ...
        self.server.ResolveService(interface, protocol, name, type, domain, avahi.PROTO_INET, dbus.UInt32(0),
    ...
    def start_service_discovery(self, component, verb, applet):
        if len(self.domain) != 0:
            ...
            self.display_notification(("Already Discovering"), "")
            return
        try:
